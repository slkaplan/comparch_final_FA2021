...
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { out }]; #IO_L13P_T2_MRCC_34 Sch=out
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { in1 }]; #IO_L14P_T2_SRCC_34 Sch=in1
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { in2 }]; #IO_L14N_T2_SRCC_34 Sch=in2
